<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $login_query=mysqli_query($conn,"INSERT INTO doctor (name, email,password,share, contact)
        VALUES ('$name', '$email', '$password','$share','$contact')"); 
        if($login_query){
            $success_msg="1";
        }
        else{
                                            ...
                                            <form class="" action="" method="post">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                    <label>share % </label>
                                                    <div>
                                                        <input data-parsley-type="number"  name="share" type="number"
                                                               class="form-control" required
