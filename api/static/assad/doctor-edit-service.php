<?php include_once('includes/header_start.php');
 ...
 include_once('includes/session.php');
    ...
    $rec_query=mysqli_query($conn,"SELECT * FROM services WHERE id ='$rec_id'"); 
    ...
    if(isset($_POST['submit'])){
        ...
        //echo $password;
        $login_query=mysqli_query($conn,"UPDATE  services SET name = '$name' , fee= '$fee' where id='$rec_id' "); 
        if($login_query){
            $success_msg="1";
        }
        else{
                                ...
                                <div class="col-lg-6">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Service Data Form</h4>
                                            <?php
                                                if($Error_msg==1){ echo '
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="number" class="form-control" required
                                                               parsley-type="number" name="fee" value="<?php echo $row['fee']; ?>" placeholder="Enter a valid e-mail"/>
                                                    </div>
                                                </div>
