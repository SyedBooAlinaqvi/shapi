<?php 
    ...
    if(!isset($_SESSION['login_user'])){ 
	  ...
	  $drid=$_SESSION['login_user'];
	  
	 // manhoos us me tw tb jaye ga code jb set ni ho ga session tera tw set na h
   ...
   $data=mysqli_query($conn,"SELECT * from dummy "); 
     ...
     if(isset($_POST['submit'])){
       ...
       // echo $doc;
        ...
        $data=mysqli_query($conn,"SELECT * from appointment where
            (appointment_date BETWEEN '$from'AND '$to') AND dr_id= '$drid'"); 
        ...
        $d_share= mysqli_query($conn,"SELECT * From doctor where id= '$drid' ");
		$d_s = mysqli_fetch_assoc($d_share);
         $Share=$d_s['share'] * $t_income;
        $doctor_share=$Share/100;
        $clinic_share=$t_income-$doctor_share;
        //echo $y;
...
<?php include_once('includes/doctor_header_end.php'); ?>
                            ...
                            <ul class="list-inline menu-left mb-0">
                                ...
                                <li class="hide-phone list-inline-item app-search">
                                    <h3 class="page-title">Doctor Sales Tables</h3>
                                </li>
                            </ul>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="" action="" method="post">
                                                 ...
                                                 <div class="   ">
                                                    ...
                                                    <div>
                                                        <input type="number" id="pass2" name="s" class="form-control" disabled="disabled" required
                                                               Value="<?php echo $doctor_share  ; ?>" />
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="number" id="pass2" name="to" class="form-control" disabled="disabled" required
                                                               value="<?php echo $clinic_share; ?>" />
                                                    </div>
