     ...
     if(isset($_POST['submit'])){
       ...
       // echo $doc;
        ...
        $data=mysqli_query($conn,"SELECT * from appointment where
            (appointment_date BETWEEN '$from'AND '$to') AND dr_id= '$doc'"); 
        ...
        $d_share= mysqli_query($conn,"SELECT * From doctor where id= '$doc' ");
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="" action="" method="post">
                                                ...
                                                <div class="form-group">
                                                            ...
                                                            <select name="doc" class="form-control"  id="doctor" required="required">
