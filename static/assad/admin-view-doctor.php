                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a  class="fa fa-edit" href="admin-edit-doctor.php?id= <?php echo $doc_id;?>">  Edit</a> 
                                                        <a  class="fa fa-eye" href="admin-view-services.php?id= <?php echo $doc_id;?>"> View Services</a>
                                                        <a  class="fa fa-trash" href="admin-delete-doctor.php?id= <?php echo $doc_id;?>"> Delete</a> 
                                                    </td>
