<?php 
 ...
 //     header("location: index.php");  
   ...
   $dataa=mysqli_query($conn,"SELECT * from appointment where
            (appointment_date BETWEEN '$today'AND '$today')AND r_id= '$id' 
            "); 
    $t_income=0;
     ...
     if(isset($_POST['submit'])){
        ...
        $data=mysqli_query($conn,"SELECT * from appointment where
            (appointment_date BETWEEN '$from'AND '$to') AND r_id= '$id' 
            "); 
...
<?php include_once('includes/header_end.php'); ?>
                            ...
                            <ul class="list-inline menu-left mb-0">
                                ...
                                <li class="hide-phone list-inline-item app-search">
                                    <h3 class="page-title">Appointment Tables</h3>
                                </li>
                            </ul>
                                ...
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Appointment Report</h4>
